...
int LCDsendNumber (int); //Envoie un nombre au LCD. Renvoie la longueur de la chaîne.
void LCDsendFloat (float,uint8_t);	//TODO: savoir comment écrire une fonction qui accepte des types de paramètres différents (int ou float ou...)
